...
public class Experiments {
   ...
   public static String comparisonTest(Instances data_TRAIN, Instances data_TEST) throws Exception {
      ...
      TreeEnsemble treeEnsemble10_P100 = new TreeEnsemble();
      treeEnsemble10_P100.setNumOfTrees(10);
      treeEnsemble10_P100.setProportionOfAttributes(1);
      TreeEnsemble treeEnsemble50_P100 = new TreeEnsemble();
      treeEnsemble50_P100.setNumOfTrees(50);
      treeEnsemble50_P100.setProportionOfAttributes(1);
      TreeEnsemble treeEnsemble100_P100 = new TreeEnsemble();
      treeEnsemble100_P100.setNumOfTrees(100);
      treeEnsemble100_P100.setProportionOfAttributes(1);
      TreeEnsemble treeEnsemble250_P100 = new TreeEnsemble();
      treeEnsemble250_P100.setNumOfTrees(250);
      treeEnsemble250_P100.setProportionOfAttributes(1);
      TreeEnsemble treeEnsemble500_P100 = new TreeEnsemble();
      treeEnsemble500_P100.setNumOfTrees(500);
      treeEnsemble500_P100.setProportionOfAttributes(1);
      TreeEnsemble treeEnsemble750_P100 = new TreeEnsemble();
      treeEnsemble750_P100.setNumOfTrees(750);
      treeEnsemble750_P100.setProportionOfAttributes(1);
      TreeEnsemble treeEnsemble1000_P100 = new TreeEnsemble();
      treeEnsemble1000_P100.setNumOfTrees(1000);
      treeEnsemble1000_P100.setProportionOfAttributes(1);

      TreeEnsemble treeEnsemble10_AVR = new TreeEnsemble();
      treeEnsemble10_AVR.setNumOfTrees(10);
      treeEnsemble10_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble50_AVR = new TreeEnsemble();
      treeEnsemble50_AVR.setNumOfTrees(50);
      treeEnsemble50_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble100_AVR = new TreeEnsemble();
      treeEnsemble100_AVR.setNumOfTrees(100);
      treeEnsemble100_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble250_AVR = new TreeEnsemble();
      treeEnsemble250_AVR.setNumOfTrees(250);
      treeEnsemble250_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble500_AVR = new TreeEnsemble();
      treeEnsemble500_AVR.setNumOfTrees(500);
      treeEnsemble500_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble750_AVR = new TreeEnsemble();
      treeEnsemble750_AVR.setNumOfTrees(750);
      treeEnsemble750_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble1000_AVR = new TreeEnsemble();
      treeEnsemble1000_AVR.setNumOfTrees(1000);
      treeEnsemble1000_AVR.setAverageDistributions(true);

      TreeEnsemble treeEnsemble10_P100_AVR = new TreeEnsemble();
      treeEnsemble10_P100_AVR.setNumOfTrees(10);
      treeEnsemble10_P100_AVR.setProportionOfAttributes(1);
      treeEnsemble10_P100_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble50_P100_AVR = new TreeEnsemble();
      treeEnsemble50_P100_AVR.setNumOfTrees(50);
      treeEnsemble50_P100_AVR.setProportionOfAttributes(1);
      treeEnsemble50_P100_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble100_P100_AVR = new TreeEnsemble();
      treeEnsemble100_P100_AVR.setNumOfTrees(100);
      treeEnsemble100_P100_AVR.setProportionOfAttributes(1);
      treeEnsemble100_P100_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble250_P100_AVR = new TreeEnsemble();
      treeEnsemble250_P100_AVR.setNumOfTrees(250);
      treeEnsemble250_P100_AVR.setProportionOfAttributes(1);
      treeEnsemble250_P100_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble500_P100_AVR = new TreeEnsemble();
      treeEnsemble500_P100_AVR.setNumOfTrees(500);
      treeEnsemble500_P100_AVR.setProportionOfAttributes(1);
      treeEnsemble500_P100_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble750_P100_AVR = new TreeEnsemble();
      treeEnsemble750_P100_AVR.setNumOfTrees(750);
      treeEnsemble750_P100_AVR.setProportionOfAttributes(1);
      treeEnsemble750_P100_AVR.setAverageDistributions(true);
      TreeEnsemble treeEnsemble1000_P100_AVR = new TreeEnsemble();
      treeEnsemble1000_P100_AVR.setNumOfTrees(1000);
      treeEnsemble1000_P100_AVR.setProportionOfAttributes(1);
      treeEnsemble1000_P100_AVR.setAverageDistributions(true);

      RandomTree randomTree = new RandomTree();

      RandomForest randomForest = new RandomForest(); //10 trees
      ...
      RotationForest rotationForest = new RotationForest(); // 3 groups
     ...
     //j48.setSeed(seed);
      ...
      classifiers.add(treeEnsemble500);
      classifiers.add(treeEnsemble750);
      classifiers.add(treeEnsemble1000);

      //100% prop.
      classifiers.add(treeEnsemble10_P100);
      classifiers.add(treeEnsemble50_P100);
      classifiers.add(treeEnsemble100_P100);
      classifiers.add(treeEnsemble250_P100);
      classifiers.add(treeEnsemble500_P100);
      classifiers.add(treeEnsemble750_P100);
      classifiers.add(treeEnsemble1000_P100);

      //50% prop. and Avr. Dist
      classifiers.add(treeEnsemble10_AVR);
      classifiers.add(treeEnsemble50_AVR);
      classifiers.add(treeEnsemble100_AVR);
      classifiers.add(treeEnsemble250_AVR);
      classifiers.add(treeEnsemble500_AVR);
      classifiers.add(treeEnsemble750_AVR);
      classifiers.add(treeEnsemble1000_AVR);

      //100% prop. and Avr. Dist
      classifiers.add(treeEnsemble10_P100_AVR);
      classifiers.add(treeEnsemble50_P100_AVR);
      classifiers.add(treeEnsemble100_P100_AVR);
      classifiers.add(treeEnsemble250_P100_AVR);
      classifiers.add(treeEnsemble500_P100_AVR);
      classifiers.add(treeEnsemble750_P100_AVR);
      classifiers.add(treeEnsemble1000_P100_AVR);
      ...
      classifiers.add(rotationForest10);
      ...
      for (Classifier c :
         ...
         try{
            ...
            System.out.println("Classifier:"+c.getClass().getSimpleName()+"=> "+e);
         }
