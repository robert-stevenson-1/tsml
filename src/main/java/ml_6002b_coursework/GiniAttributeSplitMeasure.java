...
//        System.out.println("=============");
        ...
        return AttributeMeasures.measureGini(conTable);
}
    ...
    public static void main(String[] args) throws Exception {
        ...
        GiniAttributeSplitMeasure GiniMeasure= new GiniAttributeSplitMeasure();
        ...
        System.out.println("========================================");
        System.out.println("========Use Gini index Statistic========");
        System.out.println("========================================");
        System.out.println("measure <measureGini> for attribute <Peaty> splitting diagnosis = "
                + GiniMeasure.computeAttributeQuality(whiskyData, whiskyData.attribute(0)));

        System.out.println("measure <measureGini> for attribute <Woody> splitting diagnosis = "
                + GiniMeasure.computeAttributeQuality(whiskyData, whiskyData.attribute(1)));

        System.out.println("measure <measureGini> for attribute <Sweet> splitting diagnosis = "
                + GiniMeasure.computeAttributeQuality(whiskyData, whiskyData.attribute(2)));
    }
